...
<head>
    ...
    <title>GRAIL Registration</title>
    <!-- Google Fonts: Anton -->
...
<body class="min-h-screen flex items-center justify-center relative overflow-hidden">
    ...
    <div class="relative z-10 w-full max-w-md mx-auto flex items-center justify-center min-h-[80vh]" style="min-height:80vh;">
        <div class="skew-y-[-6deg] bg-white shadow-2xl rounded-2xl p-6 sm:p-8 max-h-[80vh] overflow-y-auto flex flex-col justify-center">
            <div class="skew-y-[6deg]">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <button type="submit" class="w-full bg-[#d30707] hover:bg-[#b70707] text-white font-bold py-3 px-4 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-[#d30707] focus:ring-offset-2 font-anton text-lg tracking-wide">Create account</button>
                </form>
